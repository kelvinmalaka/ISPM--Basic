...
class AnswerValidationsTableView extends EnhancedTableView {
    /**
     ...
     * @var  string|null
     */
    public $emptyDataWords = "No team need answer validation.";
    ...
    public function repository(): Builder {
        return Team::with(["category.contest"])
            ->needAnswerValidation()
            ->whereRelation("category.committees", "committee_id", $this->committee->id)
            ->whereRelation("contest", fn(Builder $query) => $query->periodActive(PeriodType::ANSWER_VALIDATION));
    }
