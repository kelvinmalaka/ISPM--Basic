...
@section('content')
    <div class="container mx-auto px-10 py-8">
        ...
        <div class="flex items-center flex-col sm:flex-row justify-center sm:justify-between mb-4">
            <h1 class="text-lg font-bold">View Assessment Component</h1>
            ...
            <div class="text-sm breadcrumbs">
                <ul>
                    ...
                    <li class="text-gray-500">View Assessment Component</li>
                </ul>
            </div>
        </div>
        ...
        <div class="card shadow bg-base-100">
            <div class="card-body">
                <div class="mb-2">
                    @livewire('assessment-component-detail-view', ['model' => $assessmentComponent])
                </div>

                <div>
                    @livewire('judge-permissions-table-view', ['component' => $assessmentComponent])
                </div>
            </div>
        </div>
