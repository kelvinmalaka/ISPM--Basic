...
<div x-data="{
    ...
    <input :id="$id('edit-input')" x-cloak x-ref="input" x-show="editing" x-model="value"
    ...
    <div :id="$id('edit-indicator')" x-show="!editing" @click="editing = true; $nextTick(() => {$refs.input.focus()})"
        x-html="value"
